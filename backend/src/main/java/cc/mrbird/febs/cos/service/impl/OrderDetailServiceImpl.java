...
public class OrderDetailServiceImpl extends ServiceImpl<OrderDetailMapper, OrderDetail> implements IOrderDetailService {
     ...
     */
    @Override
    public IPage<LinkedHashMap<String, Object>> selectOrderDetailPage(Page<OrderDetail> page, OrderDetail orderDetail) {
        return baseMapper.selectOrderDetailPage(page, orderDetail);
    }
