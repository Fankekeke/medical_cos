...
public class InventoryStatisticsServiceImpl extends ServiceImpl<InventoryStatisticsMapper, InventoryStatistics> implements IInventoryStatisticsService {
     ...
     */
    @Override
    public IPage<LinkedHashMap<String, Object>> selectInventoryStatisticsPage(Page<InventoryStatistics> page, InventoryStatistics inventoryStatistics) {
        return baseMapper.selectInventoryStatisticsPage(page, inventoryStatistics);
    }
}
