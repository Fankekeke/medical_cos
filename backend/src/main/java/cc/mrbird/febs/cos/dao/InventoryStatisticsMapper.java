...
public interface InventoryStatisticsMapper extends BaseMapper<InventoryStatistics> {
     ...
     * @return 结果
     */
    IPage<LinkedHashMap<String, Object>> selectInventoryStatisticsPage(Page<InventoryStatistics> page, @Param("inventoryStatistics") InventoryStatistics inventoryStatistics);
}
