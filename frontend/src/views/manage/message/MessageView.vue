<template>
  <a-modal v-model="show" title="消息详情" @cancel="onClose" :width="800">
    ...
    <div style="font-size: 13px;font-family: SimHei" v-if="messageData !== null">
      <a-row style="padding-left: 24px;padding-right: 24px;">
        <a-col style="margin-bottom: 15px"><span style="font-size: 15px;font-weight: 650;color: #000c17">消息信息</span></a-col>
        <a-col :span="8"><b>接收人：</b>
...
export default {
  ...
  watch: {
    messageShow: function (value) {
      if (value) {
        this.imagesInit(this.messageData.images)
      }
    }
  },
  methods: {
