...
import BulletinAdd from './ChronicAdd.vue'
import BulletinEdit from './ChronicEdit.vue'
...
export default {
  ...
  methods: {
    ...
    batchDelete () {
      ...
      this.$confirm({
        ...
        onOk () {
          ...
          that.$delete('/cos/chronic-info/' + ids).then(() => {
    ...
    fetch (params = {}) {
      ...
      this.$get('/cos/chronic-info/page', {
        ...params
      }).then((r) => {
